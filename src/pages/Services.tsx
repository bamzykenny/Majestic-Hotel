...
const Services = () => {
  ...
  return (
    <div className="min-h-screen bg-background pt-20">
      {/* Hero Section */}
      <section className="py-20 bg-gradient-elegant" style={{ backgroundImage: `url(${bookingSectionImage})`, height: '400px', backgroundSize: 'cover', backgroundPosition: 'center', width: '100%' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="font-display text-5xl font-bold text-primary mb-6 text-white">Services & Facilities</h1>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto text-white">
            Discover our comprehensive range of luxury services and world-class facilities designed to enhance every moment of your stay.
          </p>
        </div>
      </section>
