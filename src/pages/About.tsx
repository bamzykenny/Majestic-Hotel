...
const About = () => {
  ...
  const achievements = [
    ...
    { number: "50+", label: "Industry Recognition", description: "Recognized globally for hospitality excellence" },
    { number: "150+", label: "Luxury Rooms", description: "Beautifully appointed accommodations" },
