...
>
  ...
  Reserve Your Stay
               ...
               <Button asChild variant="luxury" size="xl" className="min-w-48">
  <a href="tel:+15551234567">
    ...
    Call Now
      ...
      <section id="booking" className="py-16 bg-gradient-elegant">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="font-display text-4xl font-bold text-white mb-6">
                Why Choose Grand Luxury Hotel?
              </h2>
              <p className="text-lg text-gray-200 leading-relaxed">
                With over two decades of hospitality excellence, we've redefined luxury accommodation. 
