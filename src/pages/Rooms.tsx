...
const Rooms = () => {
  ...
  return (
    <div className="min-h-screen bg-background pt-20 ">
      {/* Header */}
      <section className="py-20 relative bg-cover bg-center bg-no-repeat" style={{ backgroundImage: `url(${juniorSuite})` }}>
        
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          <h1 className="font-display text-5xl font-bold text-primary mb-6 text-white">Rooms & Suites</h1>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto text-white">
            Discover our collection of meticulously designed accommodations, each offering a unique blend of comfort, elegance, and modern luxury amenities.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-gradient-hero text-white">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <h2 className="font-display text-4xl font-bold mb-4">Special Packages</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
            <Card className="bg-white/10 backdrop-blur-sm border-white/20">
              <CardContent className="p-6">
                <h3 className="font-display text-xl font-bold mb-2">Romantic Getaway</h3>
            ...
            <Card className="bg-white/10 backdrop-blur-sm border-white/20">
              <CardContent className="p-6">
                <h3 className="font-display text-xl font-bold mb-2">Business Package</h3>
            ...
            <Card className="bg-white/10 backdrop-blur-sm border-white/20">
              <CardContent className="p-6">
                <h3 className="font-display text-xl font-bold mb-2">Weekend Escape</h3>
