...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: Mail,
      title: "Email",
      details: ["reservations@grandluxury.com", "info@grandluxury.com"],
  ...
  return (
    <div className="min-h-screen bg-background pt-20">
      {/* Hero Section */}
      <section className="py-20 bg-gradient-elegant" style={{ backgroundImage: `url(${contactUs})`, height: '350px', backgroundSize: 'cover', backgroundPosition: 'center', width: '100%' }}>
          
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="font-display text-5xl font-bold text-primary mb-6 text-white">Contact Us</h1>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto text-white">
            We're here to assist you with reservations, inquiries, and ensuring your experience exceeds expectations. Reach out to our dedicated team anytime.
          </p>
        </div>
      </section>
